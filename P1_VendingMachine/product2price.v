// Modulo conversor de binario 4 bits (codigo do produto) para binario 11 bits (preco do produto)
// Entrada: 4 bits (0-3)
// Saída: 11 bits (0-10)
module product2price (
	input wire [3:0] BIN,
	output wire [10:0] PROD_PRICE
);

// Logica combinacional usando atribuicoes em cascata
assign PROD_PRICE = (BIN == 4'b0000) ? 11'd125 :	// 0
